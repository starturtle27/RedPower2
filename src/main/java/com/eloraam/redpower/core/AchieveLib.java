...
public class AchieveLib {
    ...
    public static AchievementPage achievepage
        = new AchievementPage("RedPower", new Achievement[0]);
    ...
    public static void registerAchievement(
        String name, int x, int y, ItemStack icon, Object require, boolean special
    ) {
    ...
    public static void
    registerAchievement(String name, int x, int y, ItemStack icon, Object require) {
